              ...
              {attachments.length > 0 && (
                ...
                >
                  {attachments.map((file, index) => (
                    <motion.div
                      key={index}
                      className="flex items-center gap-2 text-xs bg-muted/30 py-1.5 px-3 rounded-lg text-muted-foreground"
            ...
            <div className="p-4 border-t border-border flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <motion.span
                    className="absolute inset-0 bg-accent/30 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"
